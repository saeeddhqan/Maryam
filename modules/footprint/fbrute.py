...
class Module(BaseModule):
	...
	def threat(self, function, hostname, wordlist, thread_count, status_codes):
	...
	def module_run(self):
		...
		self.threat(self.request_checker, domain, dlist[:count], self.options['threat'], status_codes)
